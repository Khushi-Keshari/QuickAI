  ...
  return (
      <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
        ...
        <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
          ...
          <textarea onChange={(e)=> setInput(e.target.value)} rows={4} value={input} className='w-full p-2 px-3 mt-2 outline-none tetx-sm rounded-md border border-gray-300' placeholder='Describe what you want to see in the image....' required/>
        ...
        {/* right col */}
        <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col brder border-gray-200 min-h-96'>
          <div className='flex items-center gap-3'>
