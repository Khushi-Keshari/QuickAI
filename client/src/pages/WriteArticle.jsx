  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
        ...
        <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
          ...
          <input onChange={(e)=> setInput(e.target.value)} value={input} type="text" className='w-full p-2 px-3 mt-2 outline-none tetx-sm rounded-md border border-gray-300' placeholder='The future of Artificial Intelligence is...' required/>
        ...
        {/* right col */}
        <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col brder border-gray-200 min-h-96 max-h-[600px]'>
          <div className='flex items-center gap-3'>
          ...
          {!content?(
            ...
            // <div className='mt-3 flex-1 overflow-y-auto text-sm text-slate-600 whitespace-pre-wrap'>
            //   {content}
            // </div>
          )}
